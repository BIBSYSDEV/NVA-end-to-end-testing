...
#     And publication has AcademicChapter refering to the Antology
...
#     And Antology is present in correction list for "Antholoy without chapter"
#     When adding AcademicChapter that refers to that Antology
#     Then Antology should disappear from correction list for "Antholoy without chapter"
