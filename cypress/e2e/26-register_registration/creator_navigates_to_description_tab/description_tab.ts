...
Given('they see a Search box for Projects', () => {
...
When('they click Button for creating a new Project', () => {
  cy.getDataTestId(dataTestId.registrationWizard.description.createProjectButton)
...
Then('they see an option to cancel the funding source', () => {
...
Then('they can register:', (dataTable: DataTable) => {
