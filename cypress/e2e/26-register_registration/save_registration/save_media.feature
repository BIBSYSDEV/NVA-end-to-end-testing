Feature: Save registration for Media presentation

  @test
  Scenario Outline: Creator sees registration is saved with correct values presented on landing page for Media presentation
