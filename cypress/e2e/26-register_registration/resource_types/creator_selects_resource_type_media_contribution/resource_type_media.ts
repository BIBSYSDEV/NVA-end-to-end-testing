...
Then('they see field Medium with options:', (dataTable: DataTable) => {});
//   | Newspaper or Journal |
//   | Internet             |
//   | Radio                |
//   | TV                   |
//   | Other                |
Then('they see field Format with options:', (dataTable: DataTable) => {});
//   | Text  |
//   | Sound |
//   | Video |
Then('they see freetext input fields for:', (dataTable: DataTable) => {});
//   | Channel                   |
//   | Name of series or program |
//   | Name of issue or episode  |
Then('they can see the DOI', () => {});
