...
import { userUnitResearchDataset } from '../../../../../support/constants';
...
Then('any registered data is stored as a draft', () => {});
Then('the User sees the standard user support dialog where the user can ask for assistance', () => {});
...
Then('can be completed at any later stage', () => {});
Then('answers to user support requests will be visible on "My page"', () => {});
...
Then('a list of search matches will replace this list', () => {});
...
Then('the User has an option to contact user support', () => {});
