...
import { literaryArtsAnnouncements, literaryArtsBookFields, literaryArtsPerformanceFields, literaryArtsWebFields } from '../../../../../support/data_testid_constants'
...
When('they add a Performance with details for:', (dataTable) => {
    ...
    dataTable.rawTable.forEach(field => {
        if (field[0] === 'Type of Performance') {
            ...
            cy.get(`[data-testid=${literaryArtsPerformanceFields[field[0]]['field']}]`).type(literaryArtsPerformanceFields[field[0]]['value']);
        }
    })
})
//   | Type of Performance |
