...
export const userName = {
  ...
  [userUnitWithAuthor4]: 'Withauthor 4 TestUser',
  [userUnitWithAuthor5]: 'Withauthor 5 TestUser',
  [userUnitWithAuthor6]: 'Withauthor 6 TestUser',
  [userUnitWithAuthor7]: 'Withauthor 7 TestUser',
  [userUnitWithAuthor8]: 'Withauthor 8 TestUser',
  [userUnitSaveRegistration]: 'Save Registration TestUser',
  [userUnitAddInstitution]: 'Add institution TestUser',
  [userUnitChangeInstitution]: 'Change institution TestUser',
  [userUnitWithInstitutionRemoveInstitution]: 'Remove institution TestUser',
  [userUnitCurator]: 'Curator TestUser',
  [userUnitInstAdmin]: 'Institution-admin TestUser',
  [userSiktInstAdmin]: 'Second Institution-admin-1 TestUser',
  [adminUserUnit]: 'App-admin TestUser',
  [adminUserUnit1]: 'App-admin 1 TestUser',
  [userUnitNoRole]: 'No role TestUser',
  [userUnitRemoveOrcid]: 'Remove orcid TestUser',
  [userNonCustomer]: 'Not customer TestUser',
  [userUnitDraftDoi]: 'Draft DOI TestUser',
  [userUnitDraftDoi2]: 'Draft DOI 2 TestUser',
  [userUnitCuratorDraftDoi]: 'Curator Draft DOI TestUser',
  [userUnitResourceTypeBook]: 'Resource type book TestUser',
  [userUnitResourceTypeChapter]: 'Resource type chapter TestUser',
  [userUnitResourceTypeJournal]: 'Resource type journal TestUser',
  [userUnitResourceTypeDegree]: 'Resource type degree TestUser',
  [userUnitResourceTypeMedia]: 'Resource type media TestUser',
  [userUnitResourceTypePresentation]: 'Resource type presentation TestUser',
  [userUnitResourceTypeReport]: 'Resource type report TestUser',
  [userUnitResourceTypeArchitecture]: 'Resource type architecture TestUser',
  [userUnitViewRegistration]: 'View registration TestUser',
  [userUnitEditor]: 'Editor TestUser',
  [userBIBSYSSecondEditor]: 'Second Institution-Editor TestUser',
  [userSiktThirdEditor]: 'Third Editor TestUser',
  [userUnitEditor1]: 'Editor 1 TestUser',
  [userUnitEditor2]: 'Editor 2 TestUser',
  [userUnitEditor3]: 'Editor 3 TestUser',
  [userUnitEditor4]: 'Editor 4 TestUser',
  [userUnitEditor5]: 'Editor 5 TestUser',
  [userUnitMyRegistrations]: 'MyRegistrations TestUser',
  [userUnitFetchDoi]: 'Fetch Doi TestUser',
  [userUnitFilm]: 'Film TestUser',
  [userUnitArtistic]: 'Artistic TestUser',
  [userUnitDesign]: 'Design TestUser',
  [userUnitMusic]: 'Music TestUser',
  [userUnitLogout]: 'Log out TestUser',
  [userUnitPerformingArts]: 'Performing arts TestUser',
  [userUnitRequestSupport]: 'Request support TestUser',
  [userUnitOpenMyRegistrations]: 'Open my registrations TestUser',
  [userUnitResearchDataDmp]: 'DMP TestUser',
  [userUnitPublishedRegistration]: 'Published registration TestUser',
  [userUnitLiteraryArts]: 'Literary arts TestUser',
  [userUnitFilesAndLicense]: 'Files and license TestUser',
  [userUnitSaveJournal]: 'Save journal TestUser',
  [userUnitSaveBook]: 'Save book TestUser',
  [userUnitSaveReport]: 'Save report TestUser',
  [userUnitSaveThesis]: 'Save thesis TestUser',
  [userUnitSavePartOfBook]: 'Save part of book TestUser',
  [userUnitSavePresentation]: 'Save presentation TestUser',
  [userUnitSaveArtisticResult]: 'Save artistic result TestUser',
  [userUnitSaveMediaContribution]: 'Save media presentation TestUser',
  [userUnitSaveResearchData]: 'Save research data TestUser',
  [userUnitSaveExhibition]: 'Save exhibition TestUser',
  [userBIBSYSPublishNoRights]: 'Publish registration no rights TestUser',
  ...
  [userBIBSYSUnreadMessages]: 'Unread Messages TestUser',
  [userUnitCancelDelete]: 'Cancel delete TestUser',
  [userUnitTestMenu]: 'Menu TestUser',
  [userUnitEditRegistration]: 'Edit registration TestUser',
  [userUnitVisualArts]: 'Visual arts TestUser',
  [userUnitFavorite1]: 'Favorite TestUser',
  [userUnitFavorite2]: 'Second Favorite TestUser',
  [userUnitFavorite3]: 'Third Favorite TestUser',
  [userUnitDeleteRegistrations]: 'Delete Registrations TestUser',
  [userNtnuNviCurator]: 'Nvi-curator TestUser',
  [userNtnuNviCurator2]: 'Nvi-curator 2 TestUser',
  [userBIBSYSDoiCurator]: 'DOI-curator TestUser',
  [userBIBSYSPublishingCurator]: 'Publishing-curator TestUser',
  [userBIBSYSSupportCurator]: 'Support-curator TestUser',
  [userNtnuVerifiedContributor]: 'Access Verified contributor TestUser',
  [userUnitCuratorInstitution]: 'Access Curator institution TestUser',
  [userUnitCuratorResourceOwner]: 'Access Curator resourceowner TestUser',
  [userUnitResourceOwner]: 'Access Resource owner TestUser',
  [userUnitEditorDelete]: 'Access Editor delete TestUser',
  [userUnitCuratorDegree]: 'Access Curator degree TestUser',
  ...
  [userSintefPublicationMessages]: 'Publication Messages TestUser',
  [userSintefDOIMessages]: 'Doi Messages TestUser',
  [userSintefSupportMessages]: 'Support Messages TestUser',
  [uploaderBIBSYS]: 'collaboration A TestUser',
  [uploaderNMBU]: 'collaboration B TestUser',
  [uploaderUSN]: 'collaboration C TestUser',
  [userBIBSYSCollaborationCurator]: 'collaboration Curator A TestUser',
  [userNmbuCollaborationCurator]: 'collaboration Curator B TestUser',
  [userUSNCollaborationCurator]: 'collaboration Curator C TestUser',
  [userUSNNviInstitution]: 'User NVI-institution A TestUser',
  [userBIBSYSNviInstitution]: 'User NVI-institution B TestUser',
  [userNmbuNvaInstitution]: 'User NVA-institution C TestUser',
  [userUSNNviCuratorInstitution]: 'Curator NVI-institution A TestUser',
  [userUSNChangeNviInstitution]: 'Change User NVI-institution A TestUser',
  [userBIBSYSChangeNviInstitution]: 'Change User NVI-institution B TestUser',
  [userNmbuChangeNvaInstitution]: 'Change User NVA-institution C TestUser',
  [userUSNChangeNviCuratorInstitution]: 'NVI-Curator NVI-inst A TestUser',
  [userForegin]: 'Foreign TestUser',
