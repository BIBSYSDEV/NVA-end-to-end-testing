...
When('they can add Exhibitions of type:', (dataTable: DataTable) => {
  cy.testDataTestidList(dataTable, musicAwards);
});
// | Concert                  |
// | Audio/visual publication |
// | Music score              |
// | Other performance        |
When('they can edit existing Exhibitions', () => {
...
When('they can delete existing Exhibitions', () => {
  cy.contains('Remove');
});
