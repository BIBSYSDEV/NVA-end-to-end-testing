...
Then('they can select type of exhibition as one of:', (dataTable: DataTable) => {
  const subtypes = {
  ...
  dataTable.raw().forEach((exhibitionType) => {
...
//             | Historical interior   |
//             | Other exhibition      |
Then('the can add manifestations of types:', (dataTable: DataTable) => {
  const announcements: Map<string, string> = new Map([
