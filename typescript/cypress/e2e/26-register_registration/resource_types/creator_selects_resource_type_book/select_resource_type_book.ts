...
const bookSubtypeValues = Object.values(bookSubtypes);
const bookFieldValues = Object.values(bookFields);
...
Then('they see a list of subtypes:', (dataTable: DataTable) => {
  cy.testDataTestidList(dataTable, bookSubtypeValues);
});
// | Anthology                 |
// | Academic Monograph        |
...
When('they see fields:', (dataTable: DataTable) => {
  cy.testDataTestidList(dataTable, bookFieldValues);
});
// | Publisher             |
// | NPI discipline        |
// | ISBN                  |
