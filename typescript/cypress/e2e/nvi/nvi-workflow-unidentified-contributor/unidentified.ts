...
Given('the publication has at least one publication channel of type {string} with scientific level of one or two', (channel) => {
...
Given('the publication is not previously reported', () => {
