...
[System.Environment]::SetEnvironmentVariable("CYPRESS_AWS_USER_POOL_ID", "eu-west-1_ZgmwmNtMp", "Process")
[System.Environment]::SetEnvironmentVariable("CYPRESS_AWS_CLIENT_ID", "5lvkqvapt1bbbnalce5qu3agbi", "Process")
